...
func TestBackwardCompatibility(t *testing.T) {
	...
	legacyData := BuildTemplateData(schemas, "models", SchemaVersionLatest, false)
...
func TestExistingBehaviorPreservation(t *testing.T) {
	...
	// 기존 방식으로 데이터 생성
	templateData := BuildTemplateData([]CollectionSchema{schema}, "models", SchemaVersionLatest, false)
...
func TestTemplateCompatibility(t *testing.T) {
	...
	templateData := BuildTemplateData(schemas, "testpkg", SchemaVersionLatest, false)
...
func TestEnhancedDataBackwardCompatibility(t *testing.T) {
	...
	baseData := BuildTemplateData(schemas, "models", SchemaVersionLatest, false)
